...
namespace Tweetbook.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<IdentityUser> userManager,JwtSettings jwtSettings, TokenValidationParameters tokenValidationParameters,DataContext dataContext, RoleManager<IdentityRole> roleManager, IFacebookAuthService facebookAuthService)
        {
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            //check if token is expired. If so only then allow refresh
            ...
            //check token Jti with stored refresh token jti
        ...
        public async Task<AuthenticationResult> LoginWithFacebookAsync(string accessToken)
        {
            ...
            if (user == null)
            {
                ...
                return await GetAuthenticationResultForUserAsync(identityUser);
            }
        ...
        private async Task<AuthenticationResult> GetAuthenticationResultForUserAsync(IdentityUser user)
        {
            var tokenHandler = new JwtSecurityTokenHandler();
