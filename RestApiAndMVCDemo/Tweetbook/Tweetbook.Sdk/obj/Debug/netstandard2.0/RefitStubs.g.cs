...
namespace Tweetbook.Sdk
{
    ...
    partial class AutoGeneratedITweetbookApi : ITweetbookApi
    {
        ...
        /// <inheritdoc />
        Task<ApiResponse<PostResponse>> ITweetbookApi.GetAllAsync()
        {
        ...
        /// <inheritdoc />
        Task<ApiResponse<PostResponse>> ITweetbookApi.GetAsync(Guid postId)
        {
        ...
        /// <inheritdoc />
        Task<ApiResponse<PostResponse>> ITweetbookApi.UpdateAsync(Guid postId, UpdatePostRequest updatePostRequest)
        {
        ...
        /// <inheritdoc />
        Task<ApiResponse<string>> ITweetbookApi.DeleteAsync(Guid postId)
        {
            var arguments = new object[] { postId };
