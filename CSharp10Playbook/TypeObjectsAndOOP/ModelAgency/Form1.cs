...
public partial class Form1 : Form
{
	...
	private void lbxModels_SelectedIndexChanged(object sender, EventArgs e)
	{
		try
		{
			//SelectedItem returns object because anything might be added to a listbox
            //This is type pattern. It returns true if the cast would succeed. And if the cast works, it sets model to the correctly cast value
