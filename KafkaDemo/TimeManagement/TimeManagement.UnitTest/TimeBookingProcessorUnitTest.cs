...
namespace TimeManagement.UnitTest
{
    public class TimeBookingProcessorUnitTest
    {
        ...
        public void Test_Invalid_EmployeeId()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => timeBookingProcessor.BookTime(new Employee(), DateTime.Today, 8));
        }
        ...
        public void Test_Valid_Arguments()
        {
            ...
            Assert.True(timeBookingProcessor.BookTime(new Employee { Id = 2 }, DateTime.Today, 8));
        }
    }
}
