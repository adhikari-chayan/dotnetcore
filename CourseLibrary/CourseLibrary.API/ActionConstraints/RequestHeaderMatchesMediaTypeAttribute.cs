...
namespace CourseLibrary.API.ActionConstraints
{
    ...
    public class RequestHeaderMatchesMediaTypeAttribute:Attribute,IActionConstraint
    {
            ...
            string mediaType, params string[] otherMediaTypes)
        {
            ...
            // check if the input media types are valid media types
        ...
        /*
         The Order property decides which stage the constraint is part of. Action constraints run in groups based on the order. All of the framework-provided HTTP method attributes use the same Order value so that they run in the same stage. And what we want is for this constraint to run in that same stage as well, and that's stage 0. 
             */
        public int Order =>0;
